...
if($admin >= 3)
{
	...
	echo( "<form action=\"massemail2.php\" method=\"post\">" );
	echo( "
	...
	echo( "Email to All / <a href=\"massemail_Office.php\">Office</a> / <a href=\"massemail_Zip.php\">Zip Code</a> / <a href=\"massemail_bday.php\">Birthdays</a>" );
}
else 
{
	echo( "Email to All / <a href=\"massemail_myOffice.php.php\">Office</a> / <a href=\"massemail_Zip.php\">Zip Code</a> / <a href=\"massemail_bday.php\">Birthdays</a>" );
}
?>
