...
echo( "<form action=\"massemail_bday2.php\" method=\"post\">" );
echo( "
...
if($admin >= 3)
{
	echo( "Email to <a href=\"massemail.php\">All</a> / <a href=\"massemail_Office.php\">Office</a> / <a href=\"massemail_Zip.php\">Zip Code</a> / Birthdays" );
}
else 
{
	echo( "Email to All / <a href=\"massemail_myOffice.php\">Office</a> / <a href=\"massemail_Zip.php\">Zip Code</a> / Birthdays" );
}
?>
