...
$groupIn = mysql_real_escape_string($_POST["group"]);
...
echo( "<center>Password:<br><input class=\"blue\" name=\"password\" type=\"password\" size=\"16\" maxlength=\"16\"><br><input type=\"Button\" value=\"Login\" onclick=\"javascript:this.value='Please Wait';this.disabled=1;document.forms[0].submit()\"></center></td></tr></table></form>" );
echo( "<center>Need to update your bookmark?  <a href=\"login3.php?group=".$groupIn."\">Click here for a bookmarkable page!</a><br>" );
